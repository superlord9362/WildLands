...
public class WLVegetationFeatures {
	...
	public static final Holder<ConfiguredFeature<CountConfiguration, ?>> STARFISH = FeatureUtils.register("starfish", WLFeatures.STARFISH, new CountConfiguration(5));
	...
	public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> BEARD_MOSS = FeatureUtils.register("beard_moss", WLFeatures.BEARD_MOSS, new NoneFeatureConfiguration());
