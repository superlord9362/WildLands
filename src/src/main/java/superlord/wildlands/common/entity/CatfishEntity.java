...
public class CatfishEntity extends AbstractFish {
	...
	public CatfishEntity(EntityType<? extends CatfishEntity> type, Level worldIn) {
		super(type, worldIn);
		this.moveControl = new CatfishEntity.MoveHelperController(this);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new AvoidEntityGoal<AlligatorEntity>(this, AlligatorEntity.class, 8.0F, 2.2D, 2.2D));
	}
