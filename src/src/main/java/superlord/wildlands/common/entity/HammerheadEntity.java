...
public class HammerheadEntity extends WaterAnimal {

	public HammerheadEntity(EntityType<? extends HammerheadEntity> type, Level worldIn) {
		super(type, worldIn);
	...
	public static boolean func_223364_b(EntityType<HammerheadEntity> hammerhead, LevelAccessor level, MobSpawnType reason, BlockPos pos, Random random) {
