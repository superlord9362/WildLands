...
public class WLMiscOverworldFeatures {
	   ...
	   public static final Holder<ConfiguredFeature<BlockStateConfiguration, ?>> CONGLOMERATE_ROCK = FeatureUtils.register("conglomerate_rock", WLFeatures.BIG_BLOB.get(), new BlockStateConfiguration(WildLandsBlocks.CONGLOMERATE.get().defaultBlockState()));
	   public static final Holder<ConfiguredFeature<BlockStateConfiguration, ?>> GABBRO_ROCK = FeatureUtils.register("gabbro_rock", WLFeatures.BIG_BLOB.get(), new BlockStateConfiguration(WildLandsBlocks.GABBRO.get().defaultBlockState()));
	   public static final Holder<ConfiguredFeature<BlockStateConfiguration, ?>> DOLERITE_ROCK = FeatureUtils.register("dolerite_rock", WLFeatures.BIG_BLOB.get(), new BlockStateConfiguration(WildLandsBlocks.DOLERITE.get().defaultBlockState()));
