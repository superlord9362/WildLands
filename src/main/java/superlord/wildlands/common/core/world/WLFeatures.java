...
import superlord.wildlands.init.RegistrationProvider;

public class WLFeatures {
	
	public static final RegistrationProvider<Feature<?>> PROVIDER = RegistrationProvider.get(Registry.FEATURE_REGISTRY, WildLands.MOD_ID);
	
    public static final RegistryObject<WLAbstractTreeFeature<WLTreeConfig>> CYPRESS_TREE1 = createFeature("bald_cypress_1", () -> new Cypress1(WLTreeConfig.CODEC.stable()));
    public static final RegistryObject<WLAbstractTreeFeature<WLTreeConfig>> CYPRESS_TREE2 = createFeature("bald_cypress_2", () -> new Cypress2(WLTreeConfig.CODEC.stable()));
    public static final RegistryObject<WLAbstractTreeFeature<WLTreeConfig>> CYPRESS_TREE3 = createFeature("bald_cypress_3", () -> new Cypress3(WLTreeConfig.CODEC.stable()));
    
    public static final RegistryObject<WLAbstractTreeFeature<WLTreeConfig>> COCONUT_TREE_1 = createFeature("coconut_palm_1", () -> new Coconut1(WLTreeConfig.CODEC.stable()));
    public static final RegistryObject<WLAbstractTreeFeature<WLTreeConfig>> COCONUT_TREE_2 = createFeature("coconut_palm_2", () -> new Coconut2(WLTreeConfig.CODEC.stable()));
    public static final RegistryObject<WLAbstractTreeFeature<WLTreeConfig>> COCONUT_TREE_3 = createFeature("coconut_palm_3", () -> new Coconut3(WLTreeConfig.CODEC.stable()));
    public static final RegistryObject<WLAbstractTreeFeature<WLTreeConfig>> COCONUT_TREE_4 = createFeature("coconut_palm_4", () -> new Coconut4(WLTreeConfig.CODEC.stable()));
    public static final RegistryObject<WLAbstractTreeFeature<WLTreeConfig>> COCONUT_TREE_5 = createFeature("coconut_palm_5", () -> new Coconut5(WLTreeConfig.CODEC.stable()));
    public static final RegistryObject<WLAbstractTreeFeature<WLTreeConfig>> COCONUT_TREE_6 = createFeature("coconut_palm_6", () -> new Coconut6(WLTreeConfig.CODEC.stable()));
    public static final RegistryObject<WLAbstractTreeFeature<WLTreeConfig>> COCONUT_TREE_7 = createFeature("coconut_palm_7", () -> new Coconut7(WLTreeConfig.CODEC.stable()));
    public static final RegistryObject<WLAbstractTreeFeature<WLTreeConfig>> COCONUT_TREE_8 = createFeature("coconut_palm_8", () -> new Coconut8(WLTreeConfig.CODEC.stable()));
    public static final RegistryObject<WLAbstractTreeFeature<WLTreeConfig>> COCONUT_TREE_9 = createFeature("coconut_palm_9", () -> new Coconut9(WLTreeConfig.CODEC.stable()));
    public static final RegistryObject<WLAbstractTreeFeature<WLTreeConfig>> COCONUT_TREE_10 = createFeature("coconut_palm_10", () -> new Coconut10(WLTreeConfig.CODEC.stable()));
    public static final RegistryObject<WLAbstractTreeFeature<WLTreeConfig>> COCONUT_TREE_11 = createFeature("coconut_palm_11", () -> new Coconut11(WLTreeConfig.CODEC.stable()));
    public static final RegistryObject<WLAbstractTreeFeature<WLTreeConfig>> COCONUT_TREE_12 = createFeature("coconut_palm_12", () -> new Coconut12(WLTreeConfig.CODEC.stable()));
    public static final RegistryObject<WLAbstractTreeFeature<WLTreeConfig>> COCONUT_TREE_13 = createFeature("coconut_palm_13", () -> new Coconut13(WLTreeConfig.CODEC.stable()));

    public static final RegistryObject<BigBlockBlobFeature> BIG_BLOB = createFeature("big_blob", () -> new BigBlockBlobFeature(BlockStateConfiguration.CODEC.stable()));
    public static final RegistryObject<StarFishFeature> STARFISH = createFeature("starfish", () -> new StarFishFeature(CountConfiguration.CODEC.stable()));
    public static final RegistryObject<SmolderingLogFeature> SMOLDERING_LOG = createFeature("smoldering_log", () -> new SmolderingLogFeature(SmolderingLogFeatureConfig.field_236558_a_.stable()));
    public static final RegistryObject<BeardMossFeature> BEARD_MOSS = createFeature("weeping_vines", () -> new BeardMossFeature(NoneFeatureConfiguration.CODEC.stable()));
