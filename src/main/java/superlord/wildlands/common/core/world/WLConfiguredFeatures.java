...
public class WLConfiguredFeatures {
	...
	public static final ConfiguredFeature<?, ?> BEARD_MOSS = createConfiguredFeature("beard_moss", WLFeatures.BEARD_MOSS_FEATURE.withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).range(128).square().chance(100).func_242731_b(10));
