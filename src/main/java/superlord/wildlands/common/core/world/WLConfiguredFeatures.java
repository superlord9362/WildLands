...
public class WLConfiguredFeatures {
	...
	public static final ConfiguredFeature<WLTreeConfig, ?> BALD_CYPRESS_TREE1 = createConfiguredFeature("bald_cypress_tree_1", WLFeatures.CYPRESS_TREE1.withConfiguration(new WLTreeConfig.Builder().setTrunkBlock(WildLandsBlocks.CYPRESS_LOG.getDefaultState()).setLeavesBlock(WildLandsBlocks.CYPRESS_LEAVES.get()).setDecorators(ImmutableList.of(new BeardMossTreeDecorator())).setMinHeight(11).setMaxHeight(14).build()));
