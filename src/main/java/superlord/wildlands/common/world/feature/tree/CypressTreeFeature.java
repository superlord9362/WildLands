	...
	private void placeTree(LevelAccessor world, RandomSource random, BlockPos pos) {
		...
		if (number == 0) {
			...
			for (int y = 0; y <= heightNumber; y++) {
				...
				if (world.getBlockState(blockPos).getBlock() == Blocks.AIR && world.getBlockState(highPos.east()).getBlock() == Blocks.AIR && world.getBlockState(highPos.east(2).above()).getBlock() == Blocks.AIR && world.getBlockState(highPos.east(3).above(2)).getBlock() == Blocks.AIR && world.getBlockState(highPos.west()).getBlock() == Blocks.AIR && world.getBlockState(highPos.west(2).above()).getBlock() == Blocks.AIR && world.getBlockState(highPos.west(3).above(2)).getBlock() == Blocks.AIR && world.getBlockState(highPos.north()).getBlock() == Blocks.AIR && world.getBlockState(highPos.north(2).above()).getBlock() == Blocks.AIR && world.getBlockState(highPos.north(3).above(2)).getBlock() == Blocks.AIR && world.getBlockState(highPos.south()).getBlock() == Blocks.AIR && world.getBlockState(highPos.south(2).above()).getBlock() == Blocks.AIR && world.getBlockState(highPos.south(3).above(2)).getBlock() == Blocks.AIR && world.getBlockState(highPos.north(4).above(2)).getBlock() == Blocks.AIR && world.getBlockState(highPos.north(4).above(2).east()).getBlock() == Blocks.AIR && world.getBlockState(highPos.north(4).above(2).west()).getBlock() == Blocks.AIR && world.getBlockState(highPos.north(3).above(2).east()).getBlock() == Blocks.AIR && world.getBlockState(highPos.north(3).above(2).west()).getBlock() == Blocks.AIR && world.getBlockState(highPos.north(3).above(2).east(2)).getBlock() == Blocks.AIR && world.getBlockState(highPos.north(3).above(2).west(2)).getBlock() == Blocks.AIR && world.getBlockState(highPos.west(4).above(2)).getBlock() == Blocks.AIR && world.getBlockState(highPos.west(4).above(2).north()).getBlock() == Blocks.AIR && world.getBlockState(highPos.west(4).above(2).south()).getBlock() == Blocks.AIR && world.getBlockState(highPos.west(3).above(2).north()).getBlock() == Blocks.AIR && world.getBlockState(highPos.west(3).above(2).north(2)).getBlock() == Blocks.AIR && world.getBlockState(highPos.west(3).above(2).south()).getBlock() == Blocks.AIR && world.getBlockState(highPos.west(3).above(2).south(2)).getBlock() == Blocks.AIR && world.getBlockState(highPos.east(4).above(2)).getBlock() == Blocks.AIR && world.getBlockState(highPos.east(4).above(2).north()).getBlock() == Blocks.AIR && world.getBlockState(highPos.east(4).above(2).south()).getBlock() == Blocks.AIR && world.getBlockState(highPos.east(3).above(2).north()).getBlock() == Blocks.AIR && world.getBlockState(highPos.east(3).above(2).north(2)).getBlock() == Blocks.AIR && world.getBlockState(highPos.east(3).above(2).south()).getBlock() == Blocks.AIR && world.getBlockState(highPos.east(3).above(2).south(2)).getBlock() == Blocks.AIR)
				world.setBlock(blockPos, WLBlocks.CYPRESS_LOG.get().defaultBlockState(), 2);
