...
public class UrchinBlock extends BushBlock implements ILiquidContainer, net.minecraftforge.common.IForgeShearable {
	protected static final VoxelShape SHAPE = Block.makeCuboidShape(1.0D, 0.0D, 1.0D, 15.0D, 5D, 15.0D);
