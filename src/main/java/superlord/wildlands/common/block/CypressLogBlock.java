...
public class CypressLogBlock extends RotatedPillarBlock {

	public CypressLogBlock(Properties properties) {
		super(properties);
	}
	...
	protected void tryAbsorb(World worldIn, BlockPos pos) {
		if (this.absorb(worldIn, pos)) {
			worldIn.setBlockState(pos, WildLandsBlocks.WET_CYPRESS_LOG.get().getDefaultState(), 2);
