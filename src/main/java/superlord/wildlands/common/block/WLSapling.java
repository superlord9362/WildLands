...
import superlord.wildlands.common.world.feature.FeatureGrowerFromBlockPattern;

import java.util.ArrayList;
import java.util.List;
import java.util.Random;

public class WLSapling extends SaplingBlock implements FeatureGrowerFromBlockPattern {
    ...
    public WLSapling(Properties properties, TagKey<Block> groundTag) {
