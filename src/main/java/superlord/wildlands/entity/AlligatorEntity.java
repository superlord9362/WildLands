...
public class AlligatorEntity extends AnimalEntity implements IAngerable {
	...
	public boolean isBreedingItem(ItemStack stack) {
		return stack.getItem() == ItemInit.RAW_CATFISH.get();
	}
    ...
    public ActionResultType func_230254_b_(PlayerEntity player, Hand hand) {
        ...
        if (heldItem.getItem() == Items.WATER_BUCKET && this.isAlive() && this.isChild()) {
        	...
        	heldItem.shrink(1);
        	ItemStack itemstack1 = new ItemStack(ItemInit.ALLIGATOR_BUCKET.get());
	...
	public AgeableEntity func_241840_a(ServerWorld p_241840_1_, AgeableEntity p_241840_2_) {
		return EntityInit.ALLIGATOR.get().create(p_241840_1_);
	}
