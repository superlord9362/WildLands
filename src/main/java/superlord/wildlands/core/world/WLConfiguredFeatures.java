...
public class WLConfiguredFeatures {
	...
	public static final ConfiguredFeature<WLTreeConfig, ?> COCONUT_PALM_1 = createConfiguredFeature("coconut_palm_1", WLFeatures.COCONUT_TREE_1.withConfiguration(new WLTreeConfig.Builder().setTrunkBlock(BlockInit.COCONUT_LOG.get().getDefaultState()).setLeavesBlock(BlockInit.COCONUT_LEAVES.get()).setExtraBlock(BlockInit.WALL_COCONUT.get()).setExtraBlockEast(BlockInit.WALL_COCONUT.get().getDefaultState().with(WallCoconutBlock.FACING, Direction.EAST)).setMinHeight(20).setMaxHeight(20).build()));
	public static final ConfiguredFeature<WLTreeConfig, ?> COCONUT_PALM_2 = createConfiguredFeature("coconut_palm_2", WLFeatures.COCONUT_TREE_2.withConfiguration(new WLTreeConfig.Builder().setTrunkBlock(BlockInit.COCONUT_LOG.get().getDefaultState()).setLeavesBlock(BlockInit.COCONUT_LEAVES.get()).setMinHeight(5).setMaxHeight(5).build()));
	public static final ConfiguredFeature<WLTreeConfig, ?> COCONUT_PALM_3 = createConfiguredFeature("coconut_palm_3", WLFeatures.COCONUT_TREE_3.withConfiguration(new WLTreeConfig.Builder().setTrunkBlock(BlockInit.COCONUT_LOG.get().getDefaultState()).setLeavesBlock(BlockInit.COCONUT_LEAVES.get()).setExtraBlockWest(BlockInit.WALL_COCONUT.get().getDefaultState().with(WallCoconutBlock.FACING, Direction.WEST)).setExtraBlock(BlockInit.WALL_COCONUT.get()).setExtraBlockEast(BlockInit.WALL_COCONUT.get().getDefaultState().with(WallCoconutBlock.FACING, Direction.EAST)).setExtraBlockSouth(BlockInit.WALL_COCONUT.get().getDefaultState().with(WallCoconutBlock.FACING, Direction.SOUTH)).setMinHeight(9).setMaxHeight(9).build()));
	public static final ConfiguredFeature<WLTreeConfig, ?> COCONUT_PALM_4 = createConfiguredFeature("coconut_palm_4", WLFeatures.COCONUT_TREE_4.withConfiguration(new WLTreeConfig.Builder().setTrunkBlock(BlockInit.COCONUT_LOG.get().getDefaultState()).setLeavesBlock(BlockInit.COCONUT_LEAVES.get()).setExtraBlock(BlockInit.WALL_COCONUT.get()).setExtraBlockWest(BlockInit.WALL_COCONUT.get().getDefaultState().with(WallCoconutBlock.FACING, Direction.WEST)).setExtraBlockSouth(BlockInit.WALL_COCONUT.get().getDefaultState().with(WallCoconutBlock.FACING, Direction.SOUTH)).setExtraBlockEast(BlockInit.WALL_COCONUT.get().getDefaultState().with(WallCoconutBlock.FACING, Direction.EAST)).setMinHeight(12).setMaxHeight(12).build()));
	public static final ConfiguredFeature<WLTreeConfig, ?> COCONUT_PALM_5 = createConfiguredFeature("coconut_palm_5", WLFeatures.COCONUT_TREE_5.withConfiguration(new WLTreeConfig.Builder().setTrunkBlock(BlockInit.COCONUT_LOG.get().getDefaultState()).setLeavesBlock(BlockInit.COCONUT_LEAVES.get()).setExtraBlock(BlockInit.WALL_COCONUT.get()).setExtraBlockWest(BlockInit.WALL_COCONUT.get().getDefaultState().with(WallCoconutBlock.FACING, Direction.WEST)).setExtraBlockSouth(BlockInit.WALL_COCONUT.get().getDefaultState().with(WallCoconutBlock.FACING, Direction.SOUTH)).setExtraBlockEast(BlockInit.WALL_COCONUT.get().getDefaultState().with(WallCoconutBlock.FACING, Direction.EAST)).setMinHeight(19).setMaxHeight(19).build()));
	...
	public static final ConfiguredFeature<?, ?> RANDOM_COCONUT_TREE = createConfiguredFeature("coconut_trees", Feature.RANDOM_SELECTOR.withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(
			COCONUT_PALM_1.withChance(0.2F),
			COCONUT_PALM_2.withChance(0.2F),
