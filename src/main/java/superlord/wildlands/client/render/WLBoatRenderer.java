...
public class WLBoatRenderer extends EntityRenderer<WLBoatEntity> {
    ...
    public WLBoatRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
        this.shadowSize = 0.8F;
    }

    @Override
    public void render(WLBoatEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        matrixStackIn.push();
    ...
    @Override
    public ResourceLocation getEntityTexture(WLBoatEntity entity) {
        return BOAT_TEXTURES[entity.getWLBoatType().ordinal()];
    }
}