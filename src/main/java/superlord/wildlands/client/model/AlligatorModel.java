...
public class AlligatorModel<T extends Entity> extends EntityModel<Alligator> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition UpperJaw = Head.addOrReplaceChild("UpperJaw", CubeListBuilder.create().texOffs(0, 59).addBox(-4.5F, -4.0F, -15.0F, 9.0F, 4.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, -3.0F));
		...
		PartDefinition leftlegfront = partdefinition.addOrReplaceChild("leftlegfront", CubeListBuilder.create().texOffs(54, 0).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-7.5F, 18.0F, -6.0F));

		PartDefinition leftfootfront = leftlegfront.addOrReplaceChild("leftfootfront", CubeListBuilder.create().texOffs(48, 12).mirror().addBox(-3.5F, 0.0F, -4.0F, 5.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 6.0F, 0.0F));

		PartDefinition leftlegback = partdefinition.addOrReplaceChild("leftlegback", CubeListBuilder.create().texOffs(103, 0).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-7.5F, 18.0F, 8.0F));

		PartDefinition leftfootback = leftlegback.addOrReplaceChild("leftfootback", CubeListBuilder.create().texOffs(93, 12).mirror().addBox(-5.0F, 0.0F, -6.0F, 6.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(1.0F, 6.0F, 1.0F));

		PartDefinition rightlegback = partdefinition.addOrReplaceChild("rightlegback", CubeListBuilder.create().texOffs(103, 0).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(7.5F, 18.0F, 8.0F));
		...
		PartDefinition rightlegfront = partdefinition.addOrReplaceChild("rightlegfront", CubeListBuilder.create().texOffs(54, 0).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(7.5F, 18.0F, -6.0F));
