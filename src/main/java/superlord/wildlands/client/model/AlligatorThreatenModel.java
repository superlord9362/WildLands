...
public class AlligatorThreatenModel<T extends Entity> extends EntityModel<T> {
    ...
    public AlligatorThreatenModel() {
        ...
        this.setRotateAngle(UpperJaw, -0.7740534966278743F, 0.0F, 0.0F);
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.Head, this.leftlegfront, this.Body, this.rightlegback, this.rightlegfront, this.leftlegback).forEach((modelRenderer) -> { 
