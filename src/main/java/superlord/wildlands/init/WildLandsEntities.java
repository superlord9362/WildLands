...
public class WildLandsEntities {
	...
	public static final RegistryObject<EntityType<JellyBallEntity>> JELLY_BALL = REGISTER.register("jelly_ball", () -> EntityType.Builder.<JellyBallEntity>create(JellyBallEntity::new, EntityClassification.MISC).size(0.25F, 0.25F).build(new ResourceLocation(WildLands.MOD_ID, "jelly_ball").toString()));
	public static final RegistryObject<EntityType<CrabEntity>> CRAB = REGISTER.register("crab", () -> EntityType.Builder.<CrabEntity>create(CrabEntity::new, EntityClassification.AMBIENT).size(0.75F, 0.75F).build(new ResourceLocation(WildLands.MOD_ID, "crab").toString()));
	...
	public static final RegistryObject<EntityType<JellyfishEntity>> JELLYFISH = REGISTER.register("jellyfish", () -> EntityType.Builder.<JellyfishEntity>create(JellyfishEntity::new, EntityClassification.WATER_AMBIENT).size(1F, 1F).build(new ResourceLocation(WildLands.MOD_ID, "jellyfish").toString()));
	public static final RegistryObject<EntityType<GrizzlyEntity>> GRIZZLY = REGISTER.register("grizzly_bear", () -> EntityType.Builder.<GrizzlyEntity>create(GrizzlyEntity::new, EntityClassification.CREATURE).size(2F, 2F).build(new ResourceLocation(WildLands.MOD_ID, "grizzly_bear").toString()));
