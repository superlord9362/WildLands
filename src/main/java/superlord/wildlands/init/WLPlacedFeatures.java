...
public class WLPlacedFeatures {
	...
	public static final RegistryObject<PlacedFeature> PLACED_DISK_FINE_SAND = PLACED_FEATURES.register("placed_disk_fine_sand", () -> new PlacedFeature(WLConfiguredFeatures.CONFIGURED_DISK_FINE_SAND.getHolder().orElseThrow(), List.of(InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome())));
	...
	public static final RegistryObject<PlacedFeature> PLACED_BEARD_MOSS = PLACED_FEATURES.register("placed_beard_moss", () -> new PlacedFeature(WLConfiguredFeatures.BEARD_MOSS.getHolder().orElseThrow(), List.of(CountPlacement.of(100), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome())));
