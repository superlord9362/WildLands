...
public class WLPlacedFeatures {
	...
	public static final RegistryObject<PlacedFeature> PLACED_CYPRESS_TREE_1 = PLACED_FEATURES.register("placed_cypress_tree_1", () -> new PlacedFeature(WLConfiguredFeatures.CYPRESS_TREE_1.getHolder().orElseThrow(), List.of(PlacementUtils.filteredByBlockSurvival(WLBlocks.CYPRESS_SAPLING.get()))));
	public static final RegistryObject<PlacedFeature> PLACED_CYPRESS_TREE_2 = PLACED_FEATURES.register("placed_cypress_tree_2", () -> new PlacedFeature(WLConfiguredFeatures.CYPRESS_TREE_2.getHolder().orElseThrow(), List.of(PlacementUtils.filteredByBlockSurvival(WLBlocks.CYPRESS_SAPLING.get()))));
	public static final RegistryObject<PlacedFeature> PLACED_CYPRESS_TREE_3 = PLACED_FEATURES.register("placed_cypress_tree_3", () -> new PlacedFeature(WLConfiguredFeatures.CYPRESS_TREE_3.getHolder().orElseThrow(), List.of(PlacementUtils.filteredByBlockSurvival(WLBlocks.CYPRESS_SAPLING.get()))));

	public static final RegistryObject<PlacedFeature> PLACED_BAYOU_TREES = PLACED_FEATURES.register("placed_bayou_trees", () -> new PlacedFeature(WLConfiguredFeatures.BAYOU_TREES.getHolder().orElseThrow(), List.of(PlacementUtils.countExtra(2, 0.1F, 1), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(2), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR)));
